...
\subsection{May-Steenrod structures} In \cite{may1970general}, May considered unstable cyclic comultiplications with an additional assumption that we are not treating: That %the chain complex $C_*$ has an associative comultiplication and that 
