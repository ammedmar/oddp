...
\begin{example}
	Let $C$ be a $R$-chain complex, which we view as a $R[\Cyc_r]$-chain complex with trivial $\Cyc_r$ action.  The tensor product $\susp{\blacksquare(r-1)}\Wdualaug{r} \ot C_\blacksquare$ is the directed system $R[\Cyc_r]$-chain complexes that is also a bicomplex 
	whose differential has the following form:
	\[
