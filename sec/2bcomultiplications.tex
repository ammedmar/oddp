...
\end{proposition}
\add{
Observe that the operation $\power^0$ is computed as $y^{\otimes r}(\mu(1\hotimes a))$. Assume additionally that for each $n\geq 0$ the $R$-module $\ucadenas[n]$ has a counital coalgebra structure and that $\mu(1\otimes a)$ equals the $r$-fold diagonal $\Delta^r(a)$. In that case, if $x,y$ and $a$ are as in the proposition, then 
\[
y(a) = x^{\otimes r}(\mu(1\hotimes a)) = x^{\otimes r}(a^{\otimes r}) = (-1)^{n\binom{r}{2}} x(a)^r = x(a).
\]
I AM NOT SURE HOW TO JUSTIFY THE SECOND EQUALITY. As a consequence, $\power^0 = \id$. The operations constructed in the main theorem do satisfy that $\mu(1\hotimes a)$ is the linearization of an $r$-fold diagonal map. Thus, in the case of simplicial objects in counital commutative coassociative coalgebras, our main theorem yields connected $r$-diagonals with $\power^0=\id$.
}
