...
In this section we will construct a map $\chains(\partial\asimplex^{r-1})^{\ot n+1}\to \Per{r}$ that intertwines $\theta_j$ and $\theta$ (\cref{prop:milnor_to_per}), with $r$ an odd number. %maybe its only ^{\ot p}
